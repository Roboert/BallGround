...
<html lang="en">
  ...
  <body class="app sidebar-mini rtl">
    <!-- Navbar-->
    <header class="app-header"><a class="app-header__logo" href="index.html">東華大學</a>
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="ball_logo.php"><i class="app-menu__icon fa fa-pie-chart"></i><span class="app-menu__label">球場Logo紀錄</span></a></li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">球場時段設定</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <!--<li><a class="treeview-item" href="form-components.html"><i class="icon fa fa-circle-o"></i> 球場開放時段</a></li>
            <li><a class="treeview-item" href="form-custom.html"><i class="icon fa fa-circle-o"></i> 球場週期時段管理</a></li>-->
            <li><a class="treeview-item" href="openclose.php"><i class="icon fa fa-circle-o"></i> 球場強制控制水銀燈開關</a></li>
       ...
       <!-- <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">球場位置控制</span><i class="treeview-indicator fa fa-angle-right"></i></a>-->
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">球場管理員列表</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="member.php"><i class="icon fa fa-circle-o"></i> 球場管理員列表</a></li>
      ...
      <div class="row">
        <div class="col-md-20">
          <div class="tile">
            <div class="tile-body">
		<?php 
            $ro = $PDO->query("SELECT * FROM admin");
            $rr = $ro->fetchAll();             
		?> 
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tr>
					...
					<td align="center"> <?=$row["data_type"]?> </td>
