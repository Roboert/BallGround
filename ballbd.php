    ...
    <main class="app-content"> 
      ...
      <form class="form-inline">
          <div class="form-group">
            <h3><strong>球場:</strong></h3>
            <input class="form-control" size="15"  value="<?=$r['Ground_title']?>" type="text"  readonly>
            <label for="aaa"></label>
            <input id="aaa" class="form-control"type="text" size="10" value="<?=str_replace($r['Ground_title'],' ',$r['title'])?>" readonly>
          </div>
      </form>
          <!--<h1><p></p></h1>-->
